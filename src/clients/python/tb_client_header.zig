...
pub fn main() !void {
    ...
    try buffer.writer().print(
        ...
        \\ //////////////////////////////////////////////////////////
        \\ 
        \\typedef struct tb_uint128_t {{uint64_t high; uint64_t low;}} tb_uint128_t;
        \\
        \\
    , .{});
    ...
    try buffer.writer().print("\n", .{});
    try std.fs.cwd().writeFile("src/clients/python/tb_client/native/tb_client.h", buffer.items);
}
